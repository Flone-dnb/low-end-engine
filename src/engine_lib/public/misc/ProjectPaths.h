...
public:
    ...
    /**
     * Returns directory where the game's executable is located.
     *
     * @return Path to the directory.
     */
    static std::filesystem::path getPathToGameDirectory();
     ...
     * "C:\Users\user\AppData\Local\low-end-engine\"
     *
     * On Linux, returns something like this:
     * "~/.config/low-end-engine/"
     *
